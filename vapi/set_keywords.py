...
# 两类 keyword：
# (1) 11 家公司的辨识词根（去掉物流/科技/智能/电子等常见词）；
# (2) 车牌省份简称（单字、声学易混，如 沪/户、苏/速），偏置抬高识别概率，
#     与后端 plate_registry 近音纠错形成双保险。单字更易误触发，强度同样克制在 2。
COMPANY_KEYWORDS = [
    "晨星:2", "蓝鲸:2", "鲸鱼:2", "绿藤:2", "云杉:2", "星河:2",
    "安桥:2", "北辰:2", "海棠:2", "松果:2", "远山:2", "白泽:2",
]
# 常见上牌省份（覆盖 demo 多数车牌；需要更多省份照格式加）。
PROVINCE_KEYWORDS = [
    "沪:2", "苏:2", "浙:2", "京:2", "粤:2", "鲁:2", "皖:2",
    "豫:2", "鄂:2", "湘:2", "闽:2", "赣:2", "渝:2", "川:2",
]
KEYWORDS = COMPANY_KEYWORDS + PROVINCE_KEYWORDS
