...
仅以下 11 家可登记（测试时报这些公司名）；简称 / 音近错字 / 拼音 / 英文别名见 [`backend/data/companies.json`](backend/data/companies.json)，由后端权威校验，可替换为真实园区目录。

蓝色鲸鱼科技 · 绿藤科技 · 晨星物流 · 云杉智能 · 星河电子 · 安桥制造 · 北辰生物 · 海棠设计 · 松果新能源 · 远山材料 · 白泽机器人
...
<img src="./voice_agent_physical architecture.drawio.png" alt="物理架构" width="50%">
